...
MIN_MERGE_OBJECTS = 2
MAX_MERGE_OBJECTS = 6
IMAGE_ITER_COUNT = 1000
IMAGE_HIEGHT = 480
IMAGE_WIDTH = 640
INPUT_DIR = "./5.color_backsubbed_100/ResizedOnly/"
OUTPUT_DIR = "./11.color_merge_test/"
###                                                                          ###
################################################################################
...
class Merger():
    def __init__(self, input_file_path = "", output_file_path = ""):
        ...
        self.overlap_distance = [5, 10] ## Overlap distance
    ...
    def multi_merge(self, classes = [], item_num = 5, num = 1, index = 000):
        ...
        for iterate in range(num):
            ...
            ## background
            background = Image.new("RGBA", (IMAGE_WIDTH, IMAGE_HIEGHT), (0,0,0))
            ...
            try:
                for i in range(item_num-1):
                    ...
                    shifted_bg = Image.new("RGBA", (IMAGE_WIDTH,IMAGE_HIEGHT), (0,0,0))
                ...
                background.save(self.output_file_path + out_filename + ".jpg", format = "png")
                print(out_filename)
